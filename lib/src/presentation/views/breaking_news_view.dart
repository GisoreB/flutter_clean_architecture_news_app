...
import 'package:flutter_clean_architecture_news_app/src/presentation/views/saved_articles_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
            onTap: () => appRouter.push(const SavedArticlesView() as PageRouteInfo),
            child: const Padding(
        ...
        SliverList(
          delegate: SliverChildBuilderDelegate(
              ...
              onArticlePressed: (e) => appRouter.push(
                ArticleDetailsView(article: e) as PageRouteInfo,
              ),
            ),
